...
## 具体使用
了解，可以更具体地说明实际应用场景。这里是一个更贴合你需求的`README.md`中的段落版本：
...
如果你的屏幕设置与推荐配置不符，可能会出现好友名单缺失或采集不完全的情况。这主要是由于软件对界面元素的识别和操作依赖于特定的屏幕参数。

**解决方法**

如果在导出标签好友名单过程中遇到问题，请尝试按照以下步骤解决：
- **调整屏幕参数**：请调整您的屏幕分辨率和缩放率至推荐值，并重试操作。
